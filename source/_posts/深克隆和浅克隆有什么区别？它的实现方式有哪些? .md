...
![img](http://cdn.andiycc.com/blog_img/Ciqah16EEHqAS-yBAACmrlSP9OU378.png)

**深克隆**（Deep Clone）是将原型对象中的所有类型，无论是值类型还是引用类型，都复制一份给克隆对象，也就是说深克隆会把原型对象和原型对象所引用的对象，都复制一份给克隆对象，如下图所示：

![img](http://cdn.andiycc.com/blog_img/Ciqah16EEHqACOHEAAB2WjY2QEQ611.png)
