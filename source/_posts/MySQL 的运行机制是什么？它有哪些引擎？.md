...
![image.png](http://cdn.andiycc.com/blog_img/Ciqc1F6qtjOARs11AABEmyDSuJs566-20200830152215900.png)

**当输入正确密码之后可以连接到数据库了**，如果密码输入错误，则会提示“Access denied for user 'xxx'@'xxx' (using password: YES)”密码错误信息，如下图所示：

![image (http://cdn.andiycc.com/blog_img/CgqCHl6qtjqAHetRAAB0dQvpF6k199.png).png](https://s0.lgstatic.com/i/image/M00/00/F1/CgqCHl6qtjqAHetRAAB0dQvpF6k199.png)
...
![Java面试 16.png](http://cdn.andiycc.com/blog_img/CgqCHl6r0YyAaKAIAAFBbmI8vwQ529.png)

我们可以使用 SHOW ENGINES 命令来查看 MySQL 数据库使用的存储引擎，如下图所示：

![image (http://cdn.andiycc.com/blog_img/CgqCHl6qtn2Ac9jLAAGz-uccw7E865.png).png](https://s0.lgstatic.com/i/image/M00/00/F1/CgqCHl6qtn2Ac9jLAAGz-uccw7E865.png)
