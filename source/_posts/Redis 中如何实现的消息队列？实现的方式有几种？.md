---
title: Redis 中如何实现的消息队列？实现的方式有几种？
...
![image.png](http://cdn.andiycc.com/blog_img/CgqCHl7E8CiAPUYfAAA-J0r2Mgc997.png)

lpush 可以把最新的消息存储到消息队列（List 集合）的首部，而 rpop 可以读取消息队列的尾部，这样就实现了先进先出，如下图所示：

![image (http://cdn.andiycc.com/blog_img/Ciqc1F7E8C6AJKWJAABCSLt5htE783.png).png](https://s0.lgstatic.com/i/image/M00/0E/04/Ciqc1F7E8C6AJKWJAABCSLt5htE783.png)
...
![image (http://cdn.andiycc.com/blog_img/CgqCHl7E8D2AUKjhAABVTe21uBg498.png).png](https://s0.lgstatic.com/i/image/M00/0E/10/CgqCHl7E8D2AUKjhAABVTe21uBg498.png)
...
![image (http://cdn.andiycc.com/blog_img/CgqCHl7E8GGAbuSbAADG34Yr_oI363.png).png](https://s0.lgstatic.com/i/image/M00/0E/10/CgqCHl7E8GGAbuSbAADG34Yr_oI363.png)
